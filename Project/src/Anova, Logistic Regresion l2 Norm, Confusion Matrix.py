...
"""
Anova, Logistic Regresion l2, Confusion matrix
"""
...
rfe_svc = OneVsRestClassifier( Pipeline([('Anova', feature_selection), ('svc', LogisticRegression(penalty = 'l2', C = 0.1 , solver = 'liblinear') )]) )
fmri_masked = haxby['sub-2']['data']['1_fmrimasked']
cv = LeaveOneGroupOut()
