...
for j in ( 0.00464 , 0.01 , 0.0216 , 0.0464 , 0.1 , 0.216 , 0.464 ,  1 , 2.16 , 2.16 , 4.64 , 10):
    ...
    rfe_svc = OneVsRestClassifier( Pipeline([('Anova', feature_selection), ('svc', LinearSVC(penalty='l1', C=j, dual=False))]) )
    fmri_masked = haxby['sub-2']['data']['1_fmrimasked']
    cv = LeaveOneGroupOut()
...
plt.plot( (1 / np.array(( 0.00464 , 0.01 , 0.0216 , 0.0464 , 0.1 , 0.216 , 0.464 ,  1 , 2.16 , 2.16 , 4.64 , 10)) ) , (np.array(scores_SVM_l1_ANOVA)) )
