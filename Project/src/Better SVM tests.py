...
feature_selection = RFE(LinearSVC(penalty='l2', dual=False, multi_class= "ovo"), 50, step=0.25) #LinearSVC(), 50, step=0.25
classifier =OneVsOneClassifier( LinearSVC(penalty='l2', dual=False, multi_class= "ovo"))
