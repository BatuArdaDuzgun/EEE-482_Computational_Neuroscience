...
rfe_svc = OneVsRestClassifier( Pipeline([('Anova', feature_selection), ('svc', LogisticRegression(penalty = 'l1', C = 0.33 , solver = 'liblinear') )]) )
fmri_masked = haxby['sub-2']['data']['1_fmrimasked']
cv = LeaveOneGroupOut()
