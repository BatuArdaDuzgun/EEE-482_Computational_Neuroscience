...
"""
RFE, Logistic Regresion l1, Confusion matrix
"""
...
rfe_lr = OneVsRestClassifier( Pipeline([('rfe', feature_selection), ('lr', LogisticRegression(penalty = 'l1', C = 1 , solver = 'liblinear'))]) )
fmri_masked = haxby['sub-2']['data']['1_fmrimasked']
cv = LeaveOneGroupOut()
...
plt.title("Confusion Matrix for RFE Preprocessor and\nLogistic Regression with Penalty l1 Norm Classifier")
