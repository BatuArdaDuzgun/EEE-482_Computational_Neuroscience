...
feature_selection = RFE(LinearSVC(penalty='l1', C = 0.1 , dual=False), 50, step=0.25) #LinearSVC(), 50, step=0.25
rfe_svc = OneVsRestClassifier( Pipeline([('rfe', feature_selection), ('svc', LinearSVC(penalty='l1', C = 0.1 , dual=False))]) )
fmri_masked = haxby['sub-2']['data']['1_fmrimasked']
cv = LeaveOneGroupOut()
