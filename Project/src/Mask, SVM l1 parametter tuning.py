...
for j in ( 0.0216 , 0.0464 , 0.1 , 0.216 , 0.464 ,  1 , 2.16 , 4.64, 10):
    ...
    feature_selection = RFE(LinearSVC(penalty='l1', C=j , dual=False), 50, step=0.25) #LinearSVC(), 50, step=0.25
