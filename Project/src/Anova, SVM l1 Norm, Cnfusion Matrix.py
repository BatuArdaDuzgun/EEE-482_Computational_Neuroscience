# -*- coding: utf-8 -*-
"""
Created on Fri May 28 23:36:35 2021
...
rfe_svc = OneVsRestClassifier( Pipeline([('Anova', feature_selection), ('svc', LinearSVC(penalty='l1', C = 0.1 , dual=False))]) )
fmri_masked = haxby['sub-2']['data']['1_fmrimasked']
cv = LeaveOneGroupOut()
